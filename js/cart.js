/* ============================================================
   AMX Luxury — Shopping Cart (Single Product)
   ============================================================ */
(function () {
  'use strict';
  ...
  var PRODUCTS = {
    'cream': { name: 'Peptidermax', namePl: 'Peptidermax', price: 147, priceSub: 97, img: 'images/hero-product.png', desc: 'Advanced Peptide Cream · 50ml', descPl: 'Zaawansowany krem peptydowy · 50ml' }
  };
      ...
      html +=
        '<div class="cart-item">' +
          ...
          '<div class="cart-item__info">' +
            ...
            (item.isSub ? '<span class="cart-item__sub">' + t('6-month subscription', 'Subskrypcja 6-miesięczna') + '</span>' : '') +
